...
import { Search, Bell, User, Menu, Video, LogOut } from "lucide-react";
    ...
    <nav className="sticky top-0 z-50 w-full bg-white dark:bg-neutral-900 border-b border-gray-200 dark:border-neutral-800">
      <div className="flex items-center justify-between px-4 h-16">
        ...
        <div className="flex items-center gap-4">
          <button className="p-2 hover:bg-gray-100 dark:hover:bg-neutral-800 rounded-full md:hidden">
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          {/* Login Button (Mobile or logged out state) */}
